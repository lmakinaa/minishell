...
SRC_DIR=./srcs
SRC_C=$(SRC_DIR)/handle_prompt.c $(SRC_DIR)/ms_lexer.c $(SRC_DIR)/print_tokens.c $(SRC_DIR)/utilities.c
...
UTILS_C=$(UTILS_DIR)/ft_strcmp.c $(UTILS_DIR)/advanced_split.c $(UTILS_DIR)/ft_strlen.c $(UTILS_DIR)/ft_strchr.c $(UTILS_DIR)/ft_count_words.c\
	$(UTILS_DIR)/ft_strncmp.c $(UTILS_DIR)/ft_strncpy.c $(UTILS_DIR)/shave_parenthesis.c
